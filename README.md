**Add a new resource**: submit a pull request to add a learning resource. Categorize the resource under the appropriate section, link to it, and include a brief description.
